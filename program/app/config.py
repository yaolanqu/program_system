...
class Config:
    ...
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'yaolanqu816@163.com'
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'yang113352'
    # 使用本地bootstrap库
...
class DevelopConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'mysql://root:Root9248*@118.25.43.122:3306/bishe'
